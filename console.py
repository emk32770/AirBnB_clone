...
class HBNBCommand(cmd.Cmd):
    ...
    def do_all(self, arg):
        """Prints all the instances saved in file.json"""
        cmd_argv = arg.split()
    ...
    def do_update(self, arg):
        """ updates <class name> <id> <attribute name> <attribute value>"""
        cmd_argv = []
        part2_argv = []
        is_dict = 0
        if "\"" in arg:
    ...
    def do_count(self, arg):
        """counts <class name> or <class name>.count()"""
        cmd_argv = arg.split()
